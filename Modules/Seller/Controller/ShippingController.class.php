...
class ShippingController extends CommonController{
	...
	public function editshipping()
	{
		...
		if (IS_POST) {
			...
			$data['freeprice'] = $_GPC['default_freeprice'];
			$data['weight_chao_num']=$_GPC['default_weight_chao_num'];
			$data['jian_chao_num']=$_GPC['default_jian_chao_num'];
			$data['weight_chao_price']=$_GPC['default_weight_chao_price'];
			$data['jian_chao_price']=$_GPC['default_jian_chao_price'];
			...
			if (is_array($randoms)) {
				foreach ($randoms as $random) {
					...
					$areas[] = array('citys' => $_GPC['citys'][$random], 'citys_code' => $_GPC['citys_code'][$random], 'frist' => $_GPC['detail'][$random]['frist'], 'frist_price' => max(0, $_GPC['detail'][$random]['frist_price']), 'second' => $_GPC['detail'][$random]['second'],'second_price' => $_GPC['detail'][$random]['second_price'] ,'chao_num' => $_GPC['detail'][$random]['chao_num'],'chao_price' => $_GPC['detail'][$random]['chao_price']);
				}
			}
